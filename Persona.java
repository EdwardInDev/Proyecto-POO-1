...
/**
 * Se crea la clase Persona que contiene los atributos en común que tienen las clases JefeProyecto y Cliente para posteriormente hacer herencia
 * Se crea un constructor con los parámetros y sus métodos get, sin setters porque no se puede modificar estos datos
 * finalmente se sobreescribe el método toString que devuelve los datos de la propia clase para que puedan ser heredados en las clases hijas
