...
/**
 * Se crea la clase cliente con el atributo específico correspondiente, el resto de atributos los hereda de la clase Persona
 * que se refleja con la palabra reservada super en su constructor
 * Se crea los set y get del atributo específico
 * y finalmente se se sobreescribe el método toString que devuelve los datos de la clase Persona, el rol y la identificación del cliente
