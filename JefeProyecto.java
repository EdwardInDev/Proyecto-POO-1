...
/**
 * Se crea la clase JefeProyecto que contiene el atributo específico número de empleado y el resto de atributos los hereda de la clase Persona
 * que se indica en el constructor con la palabra reservada super, se crea el get y set del atributo específico de la clase
 * y se sobreescribe el método toString que devuelve los datos de la clase Persona, el rol y el numero de empleado
 ...
 * Se implementa un método desde una clase interface para obtener el rol del empleado
 */
